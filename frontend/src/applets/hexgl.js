            ...
            this.parse = function(jsonData) {
                ...
                if (jsonData.materials) {
                    ...
                    for (let i = 0; i < jsonData.materials.length; i++) {
                        ...
                        const color = mat.DbgColor !== undefined ? mat.DbgColor : 0x00ff00;
                    ...
                    materials.push(new THREE.MeshPhongMaterial({ color: 0x00ff00, side: THREE.DoubleSide }));
                }

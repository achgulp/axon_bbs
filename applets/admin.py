...
class AppletAdmin(admin.ModelAdmin):
    """
    Admin interface for managing Applets.
    """
    ...
    fieldsets = (
        ...
        ('Technical Details', {
            'fields': ('author_pubkey', 'code_manifest', 'parameters')
        }),
        ('Behavior', {
    ...
    readonly_fields = ('id', 'created_at', 'author_pubkey')
    
    # This makes the owner field a searchable dropdown for better usability

...
try:
    ...
    print(f"Error settin# Full path: axon_bbs/test_crypto_cycle.py
import os
import sys
import django
import traceback
...
if __name__ == "__main__":
    run_crypto_test()# Full path: axon_bbs/test_crypto_cycle.py
import os
import sys
import django
import traceback
...
def run_crypto_test():
    ...
    private_key = None
    try:
        # 1. Load and de# Full path: axon_bbs/test_crypto_cycle.py
import os
import sys
import django
import traceback
...
if __name__ == "__main__":
    run_crypto_test()crypt the local instance's private key from the database
        print("[1] Loading and decrypting local instance private key...")
        local_instance = TrustedInstance.objects.get(
            encrypted_private_key__isnull=False, 
            is_trusted_peer=False
